...
\subsubsection{Spinal Cord toolbox}
\begin{participants}
      \pers{Charley}{Gros}
...
\begin{participants}
      \pers{Élise}{Bannier}
      \pers{Giulio}{Gambarota}
     \pers{Jean-Christophe}{Ferré}
      \pers{Tobias}{Kober}
      \pers{Anca}{Nica}
      \pers{Stephan}{Chabardes}
      \pers{Claire}{Haegelen}
\end{participants}
...
\begin{itemize}
    ...
    \item Evaluation of the evolution of the cerebral blood flow changes betwwen day-of-life 3 and day-of-life 10 in a population of neonates with hypoxic-ischemic encephalopathy\cite{proisy:inserm-01944507}, ["Changes in brain perfusion in successive arterial spin labelling MRI scans in neonates with hypoxic-ischaemic encephalopathy", article in revision in Neuroimage: Clinical].
\end{itemize}
