...
\begin{composition}
\pers{Christian}{Barillot}{Chercheur}[Team leader, CNRS, Senior Researcher][Habilite]
...
\pers{Angélique}{Jarnoux}{Assistant}[Inria]
\pers{Michael}{Kain}{Technique}[Inria, until Nov 2018, granted by CEA]
\pers{Stéphanie}{Leplaideur}{PhD}[Centre hospitalier régional et universitaire de Rennes]
\pers{Florent}{Leray}{Technique}[Inria, until Feb 2018]
\pers{Giulia}{Lioi}{Technique}[Inria]
\pers{Julien}{Louis}{Technique}[Inria]
...
Best paper award by the French Institute of Psychiatry for our communication at its annual Forum~\bestcite{coloigner:hal-01890087}.
...
\begin{itemize}
    ...
    \item Expertise as a reviewer for the Comité Français d'Évaluation de la Coopération Scientifique et Universitaire avec le Brésil (Christian Barillot)
    \item Expertise as a reviewer for the Israel Science Foundation  (Christian Barillot)
    \item Expertise as a reviewer for the Research Council KU Leuven  (Christian Barillot)
    \item Expertise as a reviewer for the Swiss National Science Foundation  (Christian Barillot)
    \item Expertise as a reviewer for the "European Research Council" for the starting grant call (Christian Barillot)
\end{itemize}
...
\XMLaddatt*{type}{sanspuces}
    ...
    \begin{itemize}
        ...
        \item Quentin Duché, ``Traitements des données d'IRM fonctionnelle'' (Plenary: 1h).
...
%*TODO*: Christian: Ajouter conf press neurofeedback + article science ouest 
...
\begin{itemize}
   ...
   \item Camille Maumet: Blog post ``Extending BIDS to fMRI analyses'' \url{http://blog.camillemaumet.com/posts/11}, October, personal website. 
...
\begin{itemize}
    \item Launching of a Twitter account for the VisAGeS team (Camille Maumet) and setup on the VisAGeS website (Olivier Commowick)~\url{http://twitter.com/visages_inria}. Tweets by lab members (Quentin Duché, Christian Barillot)
