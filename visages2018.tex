...
B. Combès started as a post doc in November 2016 to process the EMISEP imaging data, starting with morphological data processing (registration, segmentation) and magnetization transfer data processing. 
        ...
        \includegraphics[width=50mm]{IMG/Hemisfer_Principle.png}
...
\end{itemize}
     \item In the context of a project at Neurinfo, Elise Bannier and Jean-Christophe Ferré collaborated with Giulio Gambarota, Anca Nica and Claire Haegelen from the LTSI and Tobias Kober from Lausanne, to evaluate a sequence named FLAWS, allowing Fluid and White Matter supression for anterior thalamic nucleus visualization. This work was presented at the ISMRM 2018 in Paris. 
